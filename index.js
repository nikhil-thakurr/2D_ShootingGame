...
const dieforyou = new Audio("./music/Die-For-You.mp3")
dieforyou.play();
...
const nikhil = new Player(playerPosition.x, playerPosition.y, 15, "white");
const weapons = [];
const hugeWeapons = [];
const enemies = [];
const particles = [];
...
function animation() {
  ...
  enemies.forEach((enemy, enemyIndex) => {
    ...
    if (distanceBetweenPlayerAndEnemy - nikhil.radius - enemy.radius < 1) {
